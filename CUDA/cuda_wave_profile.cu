...
int main(int argc, char *argv[])
{
	...
	printf("Time to Read Parameters %f\n", time_elapsed);
	...
	time_elapsed = (double)(end - begin) / CLOCKS_PER_SEC;
	printf("Time to Allocate Host Memory %f\n", time_elapsed);
	...
	time_elapsed = (double)(end - begin) / CLOCKS_PER_SEC;
	printf("Time to Allocate Device Memory %f\n", time_elapsed);
	...
	time_elapsed = (double)(end - begin) / CLOCKS_PER_SEC;
	printf("Time to Initialize Wave %f\n", time_elapsed);
